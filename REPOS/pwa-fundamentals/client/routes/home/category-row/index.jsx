...
class CategoryRow extends Component {
  ...
  componentDidMount() {
    ...
    this.props.groceryItemStore.itemListeners.register(
      this._itemUpdateListener
    );
