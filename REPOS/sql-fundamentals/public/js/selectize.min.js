    ...
    (a.prototype.getScoreFunction = function (a, b) {
      ...
      var i = function (a, b) {
          ...
          return a
            ? ((a = String(a || '')),
              (d = a.search(b.regex)),
              d === -1 ? 0 : ((c = b.string.length / a.length), 0 === d && (c += 0.5), c))
            : 0;
        },
        j = (function () {
          var a = e.length;
  ...
  var b = function (a, b) {
      return 'number' == typeof a && 'number' == typeof b
        ? a > b
          ...
          ? -1
          : 0
        : ((a = i(String(a || ''))), (b = i(String(b || ''))), a > b ? 1 : b > a ? -1 : 0);
    },
    c = function (a, b) {
      var c, d, e, f;
      for (c = 1, d = arguments.length; c < d; c++)
        if ((f = arguments[c])) for (e in f) f.hasOwnProperty(e) && (a[e] = f[e]);
      return a;
    },
    d = function (a, b, c) {
      if (a && b) {
                      ...
                      ? ((l = G(a[0])),
                        l.length
                          ...
                          : f === q &&
                            ...
                            (e = e.substring(0, l.start) + e.substring(l.start + 1)))
                      : g &&
                        ((j = c.shiftKey),
      ...
      M = function (c, d) {
        ...
        if (
          ...
          a.extend(i, {
            ...
            renderCache: {},
            onSearchChange:
              null === d.loadThrottle ? i.onSearchChange : D(i.onSearchChange, d.loadThrottle)
          }),
    ...
    return (
      ...
      a.extend(M.prototype, {
        setup: function () {
          ...
          if (
            ...
            m.plugins.names.length &&
              ((k = 'plugin-' + m.plugins.names.join(' plugin-')), b.addClass(k), e.addClass(k)),
            ...
            : void (
                ...
                setTimeout(function () {
                  ...
                  if (b.match(c.settings.splitOn))
                    for (
                      var d = a.trim(b).split(c.settings.splitOn), e = 0, f = d.length;
                      e < f;
                      e++
                    )
                      c.createItem(d[e]);
          ...
          switch (a.keyCode) {
            ...
            case h:
              return void (
                b.isOpen &&
                b.$activeOption &&
                (b.onOptionSelect({ currentTarget: b.$activeOption }), a.preventDefault())
              );
            case j:
        ...
        onKeyUp: function (a) {
          ...
          b.lastValue !== c &&
            ((b.lastValue = c), b.onSearchChange(c), b.refreshOptions(), b.trigger('type', c));
        },
            ...
            a.apply(b, [
              function (a) {
                (b.loading = Math.max(b.loading - 1, 0)),
                  a &&
                    a.length &&
                    (b.addOption(a), b.refreshOptions(b.isFocused && !b.isInputHidden)),
            ...
            b.length &&
              ...
              (!c && y(c)) ||
                ...
                g + f > e + c
                  ? j.$dropdown_content
                      .stop()
                      .animate({ scrollTop: i }, d ? j.settings.scrollDuration : 0)
                  : g < c &&
                    j.$dropdown_content
                      .stop()
                      .animate({ scrollTop: h }, d ? j.settings.scrollDuration : 0)));
        },
        selectAll: function () {
          var a = this;
            ...
            (l = i[c]),
              t.optgroups.hasOwnProperty(l) && h[l].childNodes.length
                ? ((o = document.createDocumentFragment()),
                  ...
                  o.appendChild(h[l]),
                  n.appendChild(
                    t.render('optgroup', a.extend({}, t.optgroups[l], { html: K(o), dom: o }))
                  ))
                : n.appendChild(h[l]);
        ...
        removeOptionGroup: function (a) {
          this.optgroups.hasOwnProperty(a) &&
            (delete this.optgroups[a], (this.renderCache = {}), this.trigger('optgroup_remove', a));
        },
          ...
          if (((a = a || {}), f.tagType === v)) {
            for (d = [], b = 0, c = f.items.length; b < c; b++)
              (e = f.options[f.items[b]][f.settings.labelField] || ''),
                d.push(
                  '<option value="' + A(f.items[b]) + '" selected="selected">' + A(e) + '</option>'
                );
            d.length ||
        ...
        deleteSelection: function (b) {
          ...
          if (
            !g.length ||
            ('function' == typeof l.settings.onDelete && l.settings.onDelete.apply(l, [g]) === !1)
          )
            return !1;
        ...
        advanceCaret: function (a, b) {
          ...
          0 !== a &&
            ...
            e.isShiftDown
              ? ((d = e.$control_input[c]()),
                d.length && (e.hideInput(), e.setActiveItem(d), b && b.preventDefault()))
        ...
        render: function (b, c) {
          ...
          return (
            ...
            g &&
            (y(h.renderCache[b]) || (h.renderCache[b] = {}), h.renderCache[b].hasOwnProperty(d))
              ? h.renderCache[b][d]
              : ((f = a(h.settings.render[b].apply(this, [c, A]))),
                'option' === b || 'option_create' === b
                  ? f.attr('data-selectable', '')
                  : 'optgroup' === b &&
                    ((e = c[h.settings.optgroupValueField] || ''), f.attr('data-group', e)),
      ...
      (a.fn.selectize = function (b) {
        var c = a.fn.selectize.defaults,
          ...
          l = function (b, c) {
            var k,
              ...
              s = function (b) {
                ...
                for (
                  b = a(b),
                    f = b.attr('label'),
                    f && ((g = q(b) || {}), (g[i] = f), (g[j] = f), c.optgroups.push(g)),
                    h = a('option', b),
                    d = 0,
                    e = h.length;
                  d < e;
            ...
            for (
              c.maxItems = b.attr('multiple') ? null : 1, n = b.children(), k = 0, l = n.length;
              k < l;
              k++
            )
      ...
      M.define('optgroup_columns', function (b) {
        ...
        (b.equalizeHeight || b.equalizeWidth) &&
          (B.after(this, 'positionDropdown', e), B.after(this, 'refreshOptions', e));
      }),
              ...
              return b.keyCode === p &&
                ...
                ? ((e = this.options[this.items[d]]),
                  this.deleteSelection(b) &&
                    (this.setTextboxValue(a.text.apply(this, [e])), this.refreshOptions(!0)),
                  void b.preventDefault())
