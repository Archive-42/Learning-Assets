...
export async function assertIndicesExist(db: SQLDatabase, tableName: string, indexNames: string[]) {
...
export async function assertTriggersExist(db: SQLDatabase, triggerNames: string[]) {
