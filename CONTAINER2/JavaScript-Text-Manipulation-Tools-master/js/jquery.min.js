...
!((e, t) => {
  ...
  function Ie(e, t, n) {
    for (let r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
  ...
  w.extend({
    ...
    cleanData(e) {
      for (let t, n, r, i = w.event.special, o = 0; void 0 !== (n = e[o]); o++)
        if (Y(n)) {
          if ((t = n[J.expando])) {
            if (t.events)
              for (r in t.events)
