    ...
    <View vCenter hCenter>
      <Link to="/about" style={{ textDecoration: "none" }}>
        <Card column vCenter hCenter>
          <HeadingText marginBottom={small_space} marginTop="0" hCenter>
            "Writing Good Code is a UX Problem."
          </HeadingText>
          <Text hCenter noMargin>
            Hello! I’m Alex, a designer turned fullstack web developer.
          </Text>
        </Card>
      </Link>
