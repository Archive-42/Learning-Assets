    ...
    <View hCenter>
      <Section column hCenter>
        ...
        <Card fullWidth column>
          <Text>
            <strong>Information:</strong> dkjhwoeowu
          </Text>
          <Text>
            <strong>Problem:</strong> dkjhwoeowu
          </Text>
          <Text>
            <strong>Task:</strong> dkjhwoeowu
          </Text>
          <Text>
            <strong>Technologies:</strong> dkjhwoeowu
          </Text>
        </Card>
      ...
      <Section column hCenter>
        ...
        <Text>
          Curabitur est justo, accumsan ut bibendum sit amet, semper at dui. Ut
          sit amet dolor dictum, semper est ut, suscipit nisl. Donec imperdiet
          auctor nisi, eget finibus ante tincidunt vel. Aenean non commodo odio.
        </Text>
      </Section>
      <Section column hCenter>
      ...
      <A
        to=""
        href="https://medium.com/@AlexEntrepreneur"
        target="_blank"
        fullWidth
      >
