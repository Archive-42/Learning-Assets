...
class UserCard extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <img
          src={this.props.githubProfile.avatar_url}
          alt="profile"
          height="35%"
        />
        ...
        <h5>
          Followers: {this.props.githubProfile.followers} | Following:{" "}
          {this.props.githubProfile.following}
        </h5>
        <p>Bio: : {this.props.githubProfile.bio}</p>
        <p>Followers:</p>
        <ul>
          {this.props.githubFollowers.map((follower) => (
