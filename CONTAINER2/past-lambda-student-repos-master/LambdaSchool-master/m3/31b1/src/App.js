  ...
  componentDidMount() {
    ...
    axios({
      ...
      .then((githubProfileResponse) => {
        ...
        console.log(
          `githubProfile img url = ${this.state.githubProfile.avatar_url}`
        );
      })
      .catch((err) => {
        console.log(err);
    ...
    calendarOptions.summary_text = GitHubCalendar(
      ".calendar",
      `${this.state.username}`
    );
    calendarOptions.global_stats = GitHubCalendar(
      ".calendar",
      `${this.state.username}`
    );
    calendarOptions.responsive = GitHubCalendar(
      ".calendar",
      `${this.state.username}`
    );
  ...
  getNewGHUser = (event) => {
    ...
    axios({
      ...
      .then((githubFollowerResponse) => {
        ...
        console.log(
          `GitHub follower state = ${this.state.githubFollowers.data}`
        );
      })
      .catch((err) => {
        console.log(err);
