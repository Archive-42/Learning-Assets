class List {
  ...
  contains(element) {
    return this.dataStore.find((value) => value === element) != undefined
      ? true
      : false;
  }
...
class GenericList extends List {
  ...
  insertGraterThan(element) {
    ...
    for (const key in this.dataStore) {
      if (
        (typeof element !== "string" &&
          typeof this.dataStore[key] === "string") ||
    ...
    if (grater) {
      ...
      console.log(
        `The element: ${element} is grater than elemnt's in the list`
      );
    } else {
      console.log(
        `The element: ${element} is not grater than elemnt's in the list`
      );
    }
  }
  ...
  insertSmallerThan(element) {
    ...
    if (smaller) {
      this.dataStore.push(element);
      console.log(
        `The element: ${element} is smaller than elemnt's in the list`
      );
    } else {
      console.log(
        `The element: ${element} is not smaller than elemnt's in the list`
      );
    }
  }
}
