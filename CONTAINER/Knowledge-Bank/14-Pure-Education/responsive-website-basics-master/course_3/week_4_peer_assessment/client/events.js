...
Template.addCommentForm.events({
  ...
  "click .js-add-comment": function (event) {
    ...
    var comment = {
      ...
      createdOn: new Date(),
      createdBy: user,
    }; // create a simple object to insert to the collectoin
...
Template.addSiteForm.events({
  ...
  "click .js-add-site": function (event) {
    ...
    var site = { url: url, createdOn: new Date(), createdBy: user }; // create a simple object to insert to the collectoin
